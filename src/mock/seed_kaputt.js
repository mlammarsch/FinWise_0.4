...
/* -------------------------------------------------- Basis-Daten */
export function seedData(userId, tenantId) {
...
/* --------------------------- helpers --------------------------- */
function seedAccounts(userId, tenantId) {
...
function seedCategories(userId, tenantId) {
...
function seedTransactions(userId, tenantId) {
