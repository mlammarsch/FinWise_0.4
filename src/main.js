...
router.isReady().then(() => {
    ...
    watch([() => session.currentTenantId, () => webSocketStore.connectionStatus, () => webSocketStore.backendStatus], ([newTenantId, connStatus, backendStatus], [oldTenantId, oldConnStatus, oldBackendStatus]) => {
