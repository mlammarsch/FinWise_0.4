...
export declare const useCSVImportService: import("pinia").StoreDefinition<"csvImportService", Pick<{
    ...
    csvParseStatus: import("vue").Ref<"error" | "success" | "idle" | "parsing", "error" | "success" | "idle" | "parsing">;
    error: import("vue").Ref<string, string>;
    importStatus: import("vue").Ref<"error" | "success" | "idle" | "importing", "error" | "success" | "idle" | "importing">;
