...
export const BackendAvailabilityService = {
   ...
   */
  getTooltipText(enabledText: string, checkingText = 'Backend-Status wird geprüft...', offlineText = 'Backend offline - Aktion nicht verfügbar'): string {
    if (isCheckingBackend.value) return checkingText;
