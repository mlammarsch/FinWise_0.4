...
import { useUserStore, db } from './userStore'; // Importiere db und DbSession
...
export const useSessionStore = defineStore('session', () => {
    ...
    /* ------------------------------------------------------------- Getters */
    const currentUser = computed(() => currentUserId.value ? userStore.getUserById(currentUserId.value) : undefined);
    const currentTenant = computed(() => tenantStore.activeTenant // Nutzt den activeTenant Getter aus tenantStore
    );
    /* ------------------------------------------------------------- Actions */
