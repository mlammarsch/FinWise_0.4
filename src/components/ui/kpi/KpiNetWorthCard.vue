...
const currentDate = computed(() => dayjs(props.endDate).endOf('day').toDate());
const prevDate = computed(() => dayjs(prevRange.value.end).endOf('day').toDate());

const value = computed(() => AccountService.getTotalBalance(currentDate.value));
const prevValue = computed(() => AccountService.getTotalBalance(prevDate.value));
    ...
    <div class="card-body">
      <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-y-2">
        <div class="flex flex-col">
          <h3 class="card-title text-lg">Gesamtvermögen</h3>
        ...
        <div class="flex flex-col items-start md:items-end gap-1">
          ...
          <span
            ...
            :class="badgeClass"
            aria-label="Gesamtvermögen-Trend"
          >
