...
if (__VLS_ctx.topExpenseCategories.length > 0) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "space-y-3" },
    });
    for (const [category, index] of __VLS_getVForSourceType((__VLS_ctx.topExpenseCategories))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.progress, __VLS_intrinsicElements.progress)({
            ...
            max: (__VLS_ctx.topExpenseCategories[0]?.amount || 1),
        });
    }
}
else {
...
/** @type {__VLS_StyleScopedClasses['progress-error']} */ ;
