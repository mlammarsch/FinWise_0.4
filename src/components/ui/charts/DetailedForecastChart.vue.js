...
const chartData = computed(() => {
    ...
    const connectedPositiveData = [...positiveData];
    const connectedNegativeData = [...negativeData];
...
// Watchers
watch([() => props.startDate, () => props.selectedId, () => props.type], async () => {
...
(__VLS_ctx.type === "accounts" ? "Konto" : "Kategorie");
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "text-sm opacity-70" },
});
(__VLS_ctx.forecastData?.name);
if (!__VLS_ctx.forecastData) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
